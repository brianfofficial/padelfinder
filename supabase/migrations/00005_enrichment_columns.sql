-- =============================================================================
-- Migration: 00005_enrichment_columns.sql
-- Description: Add Google Places enrichment columns and update RPC functions
-- =============================================================================
...
-- Partial index to quickly find un-enriched facilities
CREATE INDEX IF NOT EXISTS idx_facilities_google_place_id
  ON facilities (google_place_id) WHERE google_place_id IS NULL;
